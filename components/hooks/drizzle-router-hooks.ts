...
export const useGetUserCount = () => {
  const trpc = useTRPC();
  return useQuery({
    ...trpc.drizzle.getUserCount.queryOptions(),
...
export const useGetResponseCount = () => {
  const trpc = useTRPC();
  return useQuery({
    ...trpc.drizzle.getResponseCount.queryOptions(),
    ...liveCountQueryOptions,
  });
};
...
export const useGetDummyUserCount = () => {
  const trpc = useTRPC();
  return useQuery({
    ...trpc.drizzle.getDummyUserCount.queryOptions(),
    ...liveCountQueryOptions,
  });
};
  ...
  return useMutation({
    mutationFn: async (input: { studyKey: string; surveyKey: string }) => {
      return queryClient.fetchQuery({
        ...trpc.drizzle.loadSurveyByKey.queryOptions(input),
        staleTime: 0,
        gcTime: 0,
      });
    },
...
export const useGetRecentParticipantResponsesBySurveyKey = (input: {
  ...
  const queryOptions =
    trpc.drizzle.getRecentParticipantResponsesBySurveyKey.queryOptions(input);
...
export const useSubmitSurveyResponse = () => {
  ...
  const queryClient = useQueryClient();
  return useMutation(
    trpc.drizzle.submitSurveyResponse.mutationOptions({
      onSuccess: async () => {
        await queryClient.invalidateQueries(
          trpc.drizzle.getRecentParticipantResponsesBySurveyKey.pathFilter(),
        );
        await queryClient.invalidateQueries(
          trpc.drizzle.getResponseCount.pathFilter(),
        );
      },
    }),
  );
...
export const useStartAccountStressTest = () => {
  ...
  const queryClient = useQueryClient();
  return useMutation(
    trpc.drizzle.startAccountStressTest.mutationOptions({
      onSuccess: async () => {
        await queryClient.invalidateQueries(
          trpc.drizzle.getDummyUserCount.pathFilter(),
        );
        await queryClient.invalidateQueries(
          trpc.drizzle.getUserCount.pathFilter(),
        );
      },
    }),
  );
...
export const useGetAccountStressTestProgress = (
  ...
  const trpc = useTRPC();
  return useQuery({
    ...trpc.drizzle.getAccountStressTestProgress.queryOptions({
      testId: testId!,
    }),
...
export const usePurgeAllOtherUsers = () => {
  ...
  const queryClient = useQueryClient();
  return useMutation(
    trpc.drizzle.purgeAllOtherUsers.mutationOptions({
      onSuccess: async () => {
        await queryClient.invalidateQueries(
          trpc.drizzle.getUserCount.pathFilter(),
        );
...
export const usePurgeAllResponses = () => {
  ...
  const queryClient = useQueryClient();
  return useMutation(
    trpc.drizzle.purgeAllResponses.mutationOptions({
      onSuccess: async () => {
        await queryClient.invalidateQueries(
          trpc.drizzle.getResponseCount.pathFilter(),
        );
...
export const useStartContinuousSurveySpam = () => {
  const trpc = useTRPC();
  return useMutation(trpc.drizzle.startContinuousSurveySpam.mutationOptions());
};
...
export const useStopContinuousSurveySpam = () => {
  const trpc = useTRPC();
  return useMutation(trpc.drizzle.stopContinuousSurveySpam.mutationOptions());
};

export const useStartContinuousResponseLookup = () => {
  const trpc = useTRPC();
  return useMutation(
    trpc.drizzle.startContinuousResponseLookup.mutationOptions(),
  );
};
...
export const useGetContinuousResponseLookupProgress = (
  ...
  const trpc = useTRPC();
  return useQuery({
    ...trpc.drizzle.getContinuousResponseLookupProgress.queryOptions({
      testId: testId!,
    }),
    enabled: !!testId && enabled,
    refetchInterval: 500,
...
export const useStopContinuousResponseLookup = () => {
  const trpc = useTRPC();
  return useMutation(
    trpc.drizzle.stopContinuousResponseLookup.mutationOptions(),
  );
};
