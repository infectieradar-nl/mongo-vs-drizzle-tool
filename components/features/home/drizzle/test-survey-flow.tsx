...
} from "@/components/hooks/drizzle-router-hooks";
...
const SURVEY_BUTTONS = DRIZZLE_BENCHMARK_SURVEYS.map((survey) => ({
    label: survey.label,
...
const TestSurveyFlow = () => {
    const loadSurveyByKey = useLoadSurveyByKey();
